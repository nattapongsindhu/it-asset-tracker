  ...
  sections: [
    {
      ...
      children: [
        ...
        // ── 2. การเข้าสู่ระบบ ──────────────────────────────────────────────────
        h1('2. การเข้าสู่ระบบ'),
        p('ระบบใช้การยืนยันตัวตนด้วย Email และ Password ไม่ต้องติดตั้งแอปพลิเคชันใดเพิ่มเติม สามารถใช้งานผ่านเบราว์เซอร์ได้ทันที'),
        ...
        bullet('กรอก Password ในช่อง "Password"'),
        bullet('คลิกปุ่ม "Sign in"'),
        bullet('หากข้อมูลถูกต้อง ระบบจะพาไปยังหน้า Dashboard ทันที'),
        ...
        p('A: ติดต่อ Admin เพื่อรีเซ็ต Password ผ่านฐานข้อมูลโดยตรง ระบบเวอร์ชันนี้ยังไม่มีฟังก์ชัน "Forgot Password" ในหน้าเว็บ'),
